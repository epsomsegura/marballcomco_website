    ...
    <nav class="grey lighten-5 banner_pos">
        <div class="nav-wrapper">
            ...
            <ul class="sidenav grey darken-4" id="mobile">
                ...
                <li><a class="grey-text text-lighten-4" href="#"><i class="fab fa-facebook"></i> Facebook</a></li>
                <li><a class="grey-text text-lighten-4" href="#"><i class="fab fa-instagram"></i> Instagram</a></li>
                <li><a class="grey-text text-lighten-4" href="#"><i class="fab fa-twitter"></i> Twitter</a></li>
              </ul>
        </div>
    </nav>
</div>